...
import schema from '../validation/companies/companies.schema.js';
import loginSchema from '../validation/companies/companies.login.schema.js';
...
router.post('/register', async (req,res,next)=>{
    try{
        ...
        if(response!==true){
            ...
            console.log(response);
            connection.query("INSERT INTO companies (username,mobile,email,password) VALUES (?)",[[req.body.name,req.body.mobile,req.body.email,req.body.password]],(err,rows,fields)=>{
                        if(!err){
                            var response={};
                            ...
                            console.log(err);
                            error.push(err)
                            err['message']="Mobile No exists"
                            err['field']='mobile'
                            error['message']="Mobile No already exists"
