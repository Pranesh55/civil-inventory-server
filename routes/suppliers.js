...
import schema from '../validation/suppliers/suppliers.schema.js';
...
router.post('/', async (req,res,next)=>{
    try{
        ...
        if(response!==true){
            ...
            connection.query("INSERT INTO supplier (company_id,name,address,mobile,details,remarks,created_date,updated_date) VALUES (?)",[[req.query.company_id,req.body.name,req.body.address,req.body.mobile,req.body.details,req.body.remarks,new Date(),new Date()]],(err,rows,fields)=>{
                        if(!err){
                            var response={};
